...
#include "../StereoVision/appwidget.h"
...
QT_MOC_LITERAL(1, 10, 14), // "sendPauseTimer"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15) // "sendResumeTimer"

    },
    "AppWidget\0sendPauseTimer\0\0sendResumeTimer"
};
...
void AppWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendPauseTimer(); break;
        case 1: _t->sendResumeTimer(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppWidget::sendPauseTimer)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AppWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppWidget::sendResumeTimer)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AppWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AppWidget.data,
      qt_meta_data_AppWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AppWidget::sendPauseTimer()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AppWidget::sendResumeTimer()
{
